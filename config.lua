...
Config.Events = {
    ...
    [`EVENT_CARRIABLE_UPDATE_CARRY_STATE`] = {
        name = "EventCarriableUpdateCarryState",
        size = 5,
        outputs = {
            [3] = "boolean",
            [4] = "boolean",
    ...
    [`EVENT_CARRIABLE_VEHICLE_STOW_COMPLETE`] = {
        name = "EventCarriableVehicleStowComplete",
        size = 3,
        outputs = {
            [2] = "boolean"
        }
    ...
    [`EVENT_CONTAINER_INTERACTION`] = {
        name = "EventContainerInteraction",
        size = 4,
        outputs = {
            [3] = "boolean"
        }
    ...
    [`EVENT_INVENTORY_ITEM_PICKED_UP`] = {
        name = "EventInventoryItemPickedUp",
        size = 5,
        outputs = {
            [2] = "boolean",
            [3] = "boolean"
    ...
    [`EVENT_NETWORK_MINIGAME_REQUEST_COMPLETE`] = {
        name = "EventNetworkMinigameRequestComplete",
        size = 6,
        outputs = {
            [4] = "boolean"
        }
    ...
    [`EVENT_NETWORK_POSSE_DISBANDED`] = {
        name = "EventNetworkPosseDisbanded",
        size = 2,
        outputs = {
            [0] = "boolean"
        }
    ...
    [`EVENT_NETWORK_PROJECTILE_ATTACHED`] = {
        name = "EventNetworkProjectileAttached",
        size = 6,
        outputs = {
            [2] = "float",
            [3] = "float",
    ...
    [`EVENT_PLACE_CARRIABLE_ONTO_PARENT`] = {
        name = "EventPlaceCarriableOntoParent",
        size = 6,
        outputs = {
            [4] = "boolean"
        }
